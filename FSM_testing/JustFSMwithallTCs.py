...
# 4B. SMTC ANALOG TEMP READING FOR TESTING
...
def main():
    ...
    try:
        while True:
            # Read temps from SMTC instead of 1-wire (TEST MODE)
            T_amb = read_temp_smtc(5)   # thermostat / room temp
            T_amb2 = read_temp_smtc(6)  # inlet / tank temp
