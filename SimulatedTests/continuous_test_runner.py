...
# =========================================================
# 3. 1-WIRE SENSOR MAP
#    Update these IDs to match your actual sensors on the Pi.
# =========================================================
SENSOR_MAP = {
    "28-00000037009c": "tank_outlet",   # known from your current code

    # Replace these placeholder IDs with your actual sensor IDs:
    # "28-xxxxxxxxxxxx": "tank_inlet",
    # "28-yyyyyyyyyyyy": "hex_inlet",
    # "28-zzzzzzzzzzzz": "hex_outlet",
}
...
def run_continuous_test():
    ...
    try:
        for minute_index, row in enumerate(CONTINUOUS_TEST, start=1):
            ...
            print(f"Tank Inlet:             {fmt_temp(tank_inlet)}")
            print(f"Tank Outlet:            {fmt_temp(tank_outlet)}")
